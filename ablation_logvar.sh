...
CONFIGS=(
  "simple_mamba_gml_rollout     models.architecture.block_type=simple models.architecture.mamba_type=mamba training.mode=gml_rollout models.out_dim=10"
  "cls_gml_out10           	models.architecture.block_type=cls  training.mode=gml_rollout models.out_dim=10"
  "attention_gml_1e0d_out10     models.architecture.block_type=attention  training.mode=gml_rollout models.out_dim=10 models.architecture.n_encoder_layers=1 models.architecture.n_decoder_layers=0"
)
...
RUNS_DIR="ablation_logvar/runs/${RUN_ID}"
RESULTS_DIR="ablation_logvar/results/${RUN_ID}"
