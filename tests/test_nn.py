...
def main():
    ...
    train_data = PolynomialGenerator(num_points=400, begin=-10, end=10, len_batch=400000)
    test_data = PolynomialGenerator(num_points=400, begin=-10, end=10, len_batch=5000)
