...
#
# Consolidated from: ablation.sh, ablation2.sh, ablation3.sh, ablation4.sh
set -euo pipefail
GPU_ID=0
...
CONFIGS=(
  ...
  "simple_gml_mamba_short_rollout   models.architecture.block_type=simple models.architecture.mamba_type=mamba training.mode=gml_rollout training.rollout_steps=4"
  "simple_gml_mamba_long_rollout    models.architecture.block_type=simple models.architecture.mamba_type=mamba training.mode=gml_rollout training.rollout_steps=32"
  "simple_gml_mamba_out6            models.architecture.block_type=simple models.architecture.mamba_type=mamba training.mode=gml_rollout models.out_dim=6"
  "simple_gml_mamba_out10           models.architecture.block_type=simple models.architecture.mamba_type=mamba training.mode=gml_rollout models.out_dim=10"
  "simple_gml_mamba_out13           models.architecture.block_type=simple models.architecture.mamba_type=mamba training.mode=gml_rollout models.out_dim=13"
)
